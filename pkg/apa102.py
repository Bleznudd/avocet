"""
The code comes from https://github.com/respeaker/mic_hat/blob/master/interfaces
...
class APA102:
    ...
    """
    # Constants
    MAX_BRIGHTNESS = 0b00001 # Safeguard: Set to a value appropriate for your setup
